namespace AmrAmin.DesignPatterns.Behavioral.ObserverPattern;

using AmrAmin.DesignPatterns;
using AmrAmin.DesignPatterns.Behavioral.ObserverPattern.ObservableCommunicationStyle;
using AmrAmin.DesignPatterns.Behavioral.ObserverPattern.ObserverStockExample;

using PullStyle = PullCommunicationStyle;
using PushStyle = PushCommunicationStyle;
