namespace AmrAmin.DesignPatterns.Behavioral.MementoPattern;
using System;

using AmrAmin.DesignPatterns;
using AmrAmin.DesignPatterns.Behavioral.MementoPattern.EditorExample;
using AmrAmin.DesignPatterns.Behavioral.MementoPattern.GangOfFourExample;
